import InvoicesDashboardClient from './invoices-dashboard-client';
      ...
      <header className="space-y-6 rounded-3xl border border-white/10 bg-slate-950/70 p-8 shadow-2xl shadow-slate-950/40 backdrop-blur">
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            <h1 className="text-3xl font-semibold text-white sm:text-4xl">Invoices &amp; bills</h1>
            <p className="max-w-2xl text-sm text-slate-300 sm:text-base">
              Audit vendor invoices, due dates, and payment status sourced from the latest spreadsheet import.
            </p>
          </div>
        </div>
      </header>
